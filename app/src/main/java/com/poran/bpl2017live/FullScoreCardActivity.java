...
public class FullScoreCardActivity extends ActionBarActivity {
                        ...
                        if (!partnerships) {
                            if (trTagStarted) {
                                if (name.equals("th") || name.equals("td")) {
                                    ...
                                    textView.setTextColor(getResources().getColor(R.color.A400));
    ...
    private void getInnings(JSONObject val, TeamDetails team1, TeamDetails team2) throws JSONException {
        ...
        for (Inning i : inningArrayList) {
            ...
            name.setTextColor(getResources().getColor(R.color.A400));

            data.setTextColor(getResources().getColor(R.color.A400));
            data.setText( i.runs+"/"+i.wickets+"("+i.overs+" Overs"+")" + "    \nRun Rate: " + i.run_rate + "   Wickets: " + i.wickets + "   Overs: " + i.overs);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            tvDescription.setTextColor(getResources().getColor(R.color.A400));
                            tvSummary.setText(status);
                            tvSummary.setTextColor(getResources().getColor(R.color.A400));
                            getMatchCard(val);
                            //innings
                            getTeamDetails(val);
